...
public class Deafen : IDisposable
{
    ...
    public Deafen(TosuApi tosuAPI, SettingsHandler settingsHandler, BreakPeriodCalculator breakPeriodCalculator, SharedViewModel sharedViewModel)
    {
        _tosuAPI = tosuAPI;
        ...
        Console.WriteLine($"[Init] Deafen hotkey: {_customKeybind}");
        
        // handled separately from maintimer just in case
        _timer = new Timer(500);
        _timer.Elapsed += (s, e) => CheckAndDeafen();
        _timer.Start();
        Console.WriteLine("[Init] Timer started for CheckAndDeafen every 500ms");
    }
    ...
    private void SimulateDeafenKey()
    {
        try
        {
            ...
            foreach (var (modifiers, key) in keybinds)
            {
                ...
                Console.WriteLine($"[SimulateDeafenKey] Released modifiers: {string.Join(", ", modifiers.Reverse())}");
            }
        }
        catch (Exception ex)
        {
    ...
    private bool ShouldDeafen()
    {
        ...
        Console.WriteLine("Required completion percentage: " + requiredCompletion);
        ...
        bool notPracticeDifficulty = _tosuAPI.GetRankedStatus() != 1;
    ...
    private bool ShouldUndeafen()
    {
        ...
        if (IsUndeafenAfterMissEnabled && !isFullCombo && _deafened)
        {
    ...
    public void CheckAndDeafen()
    {
        Console.WriteLine("[CheckAndDeafen] Checking deafen/undeafen state...");
        if (ShouldDeafen())
        {
        ...
        {
            Console.WriteLine("[CheckAndDeafen] No state change required.");
        }
    }
...
var specialKeys = new Dictionary<string, KeyCode>(StringComparer.OrdinalIgnoreCase)
{
    ...
    { "Shift", KeyCode.VcLeftShift }, { "LeftShift", KeyCode.VcLeftShift }, { "RightShift", KeyCode.VcRightShift },
    ...
    { "Up", KeyCode.VcUp }, { "Down", KeyCode.VcDown }, { "Left", KeyCode.VcLeft }, { "Right", KeyCode.VcRight },
    ...
    { "CapsLock", KeyCode.VcCapsLock }, { "NumLock", KeyCode.VcNumLock }, { "ScrollLock", KeyCode.VcScrollLock },
    ...
    { "NumPad9", KeyCode.VcNumPad9 }, { "NumPadAdd", KeyCode.VcNumPadAdd }, { "NumPadSubtract", KeyCode.VcNumPadSubtract },
    ...
    { "A", KeyCode.VcA }, { "B", KeyCode.VcB }, { "C", KeyCode.VcC }, { "D", KeyCode.VcD }, { "E", KeyCode.VcE },
    { "F", KeyCode.VcF }, { "G", KeyCode.VcG }, { "H", KeyCode.VcH }, { "I", KeyCode.VcI }, { "J", KeyCode.VcJ },
    { "K", KeyCode.VcK }, { "L", KeyCode.VcL }, { "M", KeyCode.VcM }, { "N", KeyCode.VcN }, { "O", KeyCode.VcO },
    { "P", KeyCode.VcP }, { "Q", KeyCode.VcQ }, { "R", KeyCode.VcR }, { "S", KeyCode.VcS }, { "T", KeyCode.VcT },
    { "U", KeyCode.VcU }, { "V", KeyCode.VcV }, { "W", KeyCode.VcW }, { "X", KeyCode.VcX }, { "Y", KeyCode.VcY },
    { "Z", KeyCode.VcZ },
    { "0", KeyCode.Vc0 }, { "1", KeyCode.Vc1 }, { "2", KeyCode.Vc2 }, { "3", KeyCode.Vc3 }, { "4", KeyCode.Vc4 },
    ...
    for (var i = 0; i < parts.Length; i++)
    {
        ...
        if (trimmedPart == "Shift" || trimmedPart == "Ctrl" || trimmedPart == "Alt" || trimmedPart == "Win" ||
            ...
            trimmedPart == "LeftWin" || trimmedPart == "RightWin" || trimmedPart == "Control")
        {
